...
```
kubectl logs -f csi-iscsi-for-windows-node-klh5c -c iscsi
I1217 14:40:55.928307       7 driver.go:48] Driver: iscsi.csi.windows.microsoft.com version: 1.0.0
...
I1217 14:40:55.957874       7 utils.go:69] GRPC response: {"name":"iscsi.csi.windows.microsoft.com","vendor_version":"1.0.0"}
...
I1217 14:40:56.767445       7 utils.go:69] GRPC response: {"name":"iscsi.csi.windows.microsoft.com","vendor_version":"1.0.0"}
```
...
csi-iscsi-for-windows-node   1         1         1       1            1           kubernetes.io/os=linux   51m

kubectl edit daemmonset csi-iscsi-for-windows-node
```
...
iscsi.csi.windows.microsoft.com   false            false            false             <unset>         false               Persistent   22m
```
